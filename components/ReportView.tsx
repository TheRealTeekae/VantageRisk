  ...
  return (
    <div className="bg-slate-900 text-white rounded-xl p-8">
      ...
      <p className="text-slate-400 text-sm mt-1">
        Renewal Intelligence Report &middot; {formatDate(report.generatedAt)}
      </p>
    </div>
  );
}
    ...
    <section className="bg-white rounded-xl border border-slate-200 p-6">
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <Stat
          ...
          value={lossTrendAnalysis.yearsAnalyzed != null ? String(lossTrendAnalysis.yearsAnalyzed) : "—"}
        />
        <Stat
          label="Open Claims"
          value={lossTrendAnalysis.openClaimCount != null ? String(lossTrendAnalysis.openClaimCount) : "—"}
        />
        <Stat
          label="Large Losses"
          value={lossTrendAnalysis.largeLossCount != null ? String(lossTrendAnalysis.largeLossCount) : "—"}
        />
      </div>
        ...
        <BarChart data={data} margin={{ top: 8, right: 16, left: 8, bottom: 4 }}>
          ...
          <Tooltip
            formatter={(value, name) => [
              ...
              (name as string) === "paid" ? "Paid Losses" : "Reserves",
            ]}
